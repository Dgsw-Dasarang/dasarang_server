...
public class FindAllEducationByCategoryService {

    private final EducationFacade educationFacade;

    @Transactional
    public EducationListResponse execute(EducationCategory category, String content, int page, int size) {
        Pageable pageable = PageRequest.of(page - 1, size);
        Page<Education> educations = educationFacade.findEducationByCategory(category, pageable, content);
